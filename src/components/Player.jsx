    ...
    <div className='h-[10%] bg-black flex justify-between items-center text-white px-4'>
      ...
      <div className='flex flex-col items-center gap-1 m-auto'>
            <div className='flex gap-4'>
                ...
                <img onClick={previous} className='w-4 hover:scale-110 cursor-pointer' src={assets.prev_icon} alt=''/>
                {playStatus ?
                <img onClick={pause} className='w-4 hover:scale-110  cursor-pointer' src={assets.pause_icon} alt=''/>
                :
                <img onClick={play} className='w-4 hover:scale-110  cursor-pointer' src={assets.play_icon} alt=''/>
              }  
                <img onClick={next} className='w-4 hover:scale-110 cursor-pointer' src={assets.next_icon} alt=''/>
